...
def hash_block(block_data):
    ...
    return bytearray(hashlib.sha256(byte_im+block_data).digest())
...
class MyTCPHandler(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        ...
        while 1:
            ...
            buff = self.request.recv(4-len(size_t))
        ...
        while 1:
            ...
            buff = self.request.recv(block_data_len - len(block_data))
            
            if not buff:
                break
                
            block_data = block_data + buff
...
if __name__ == "__main__":
    ...
    while i < 256:
        ...
        if hash_block( sample_data ) != hash_arr[i]:
        
            print("!!!!!!!!!!!! ERROR !!!!!!!!!!!!\n")
            print("Test calculation could not be performed correctly!\n")
            print("Test data was generated with OpenCV 3.2\n")
            print("Your OpenCV version: "+cv2.__version__+"\n")
            print("TRY: pip3 install opencv-python==3.2.0.6\n")
            exit()        
    ...
    # Create the server, binding to 127.0.0.1 on port 9999
